...
Vocab,trainData=loadTrainSet("../data/state_643459.txt","../data/train_all.txt")
...
function test(inPutFilename,outPutFileName)
  ...
  local state=io.input("../data/state_643459.test.txt")
  local l=io.read("*line"):split(" ")
  state:close()
...
while true do
  -- train
  train(trainData)
  test("../data/test_643459.txt",outPutFileName)
